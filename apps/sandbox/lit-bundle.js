...
var i = (t3, ...e4) => {
  const o6 = 1 === t3.length ? t3[0] : e4.reduce((e5, s3, o7) => e5 + ((t4) => {
...
var S = (s3, o6) => {
  if (e) s3.adoptedStyleSheets = o6.map((t3) => t3 instanceof CSSStyleSheet ? t3 : t3.styleSheet);
  else for (const e4 of o6) {
    const o7 = document.createElement("style"), n4 = t.litNonce;
    void 0 !== n4 && o7.setAttribute("nonce", n4), o7.textContent = e4.cssText, s3.appendChild(o7);
  }
};
...
var V = (t3, i5) => {
  ...
  for (let i6 = 0; i6 < s3; i6++) {
    ...
    l3 += c4 === f2 ? s4 + n3 : d3 >= 0 ? (o6.push(a3), s4.slice(0, d3) + e3 + s4.slice(d3) + h2 + x2) : s4 + h2 + (-2 === d3 ? i6 : x2);
  }
  return [P(t3, l3 + (t3[s3] || "<?>") + (2 === i5 ? "</svg>" : 3 === i5 ? "</math>" : "")), o6];
};
var N = class _N {
...
function S2(t3, i5, s3 = t3, e4) {
  ...
  return h3?.constructor !== o6 && (h3?._$AO?.(false), void 0 === o6 ? h3 = void 0 : (h3 = new o6(t3), h3._$AT(t3, s3, e4)), void 0 !== e4 ? (s3._$Co ??= [])[e4] = h3 : s3._$Cl = h3), void 0 !== h3 && (i5 = S2(t3, h3._$AS(t3, i5.values), h3, e4)), i5;
}
var M = class {
  constructor(t3, i5) {
  ...
  u(t3) {
    ...
    C.currentNode = e4;
    let h3 = C.nextNode(), o6 = 0, n4 = 0, l3 = s3[0];
    for (; void 0 !== l3; ) {
      if (o6 === l3.index) {
        let i6;
...
var k = class {
  ...
  _$AI(t3, i5 = this, s3, e4) {
    ...
    if (void 0 === h3) t3 = S2(this, t3, i5, 0), o6 = !c3(t3) || t3 !== this._$AH && t3 !== T, o6 && (this._$AH = t3);
      ...
      const e5 = t3;
      let n4, r5;
      for (t3 = h3[0], n4 = 0; n4 < h3.length - 1; n4++) r5 = S2(this, e5[s3 + n4], i5, n4), r5 === T && (r5 = this._$AH[n4]), o6 ||= !c3(r5) || r5 !== this._$AH[n4], r5 === E ? t3 = E : t3 !== E && (t3 += (r5 ?? "") + h3[n4 + 1]), this._$AH[n4] = r5;
    }
    o6 && !e4 && this.j(t3);
  }
  j(t3) {
