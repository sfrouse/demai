...
const ProspectContent = () => {
    ...
    const isLoading = contentState.research === undefined; // || !spaceStatus?.valid;
            ...
            >
                ...
                >
                    ...
                    >
                        <FormControl
                            isRequired
                            isInvalid={!prospectName && submitted}
                        >
                            ...
                            <TextInput
                                ...
                                onChange={(e) =>
                                    setPropsectName(e.target.value)
                                }
                            />
                        ...
                        <FormControl
                            isRequired
                            isInvalid={!mainWebsite && submitted}
                        >
                        ...
                        <FormControl
                            isRequired
                            isInvalid={!seDescription && submitted}
                        >
                            ...
                            <Textarea
                                ...
                                onChange={(e) =>
                                    setSEDescription(e.target.value)
                                }
                                style={{ height: 200 }}
                            />
                            <FormControl.HelpText>
                                Provide a short description, just enough to
