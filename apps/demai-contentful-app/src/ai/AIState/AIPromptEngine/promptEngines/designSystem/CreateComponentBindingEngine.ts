...
export class CreateComponentBindingEngine extends AIPromptEngine {
  constructor(aiState: AIState) {
    super(aiState);

    this.system = {
      role: "system",
      content: `You are an expert in Design Systems and are helping guide a Solutions Engineer
      navigate creating the binding between a content type and a component definition.`,
    };
