...
export default async function createCTypeFromCDef(
    ...
    // Everyone should have a title - displayTitle
    const titleField = newCType.fields.find((field) => field.id === "title");
    if (!titleField) {
        newCType.fields.unshift({
            id: "title",
            name: "Title",
            type: "Symbol",
            omitted: false,
    ...
    try {
        ...
        cType.displayField = newCType.displayField || "title";
