...
import createPageController from "./tools/createPageController";
...
export class DesignSystemMCPClient extends MCPClient {
    ...
    async callFunction(toolName: string, params: any) {
        switch (toolName) {
            ...
            case createPageController.toolName: {
                return createPageController.functionCall(this, params);
            }
            default: {
                return {
                    content: [
